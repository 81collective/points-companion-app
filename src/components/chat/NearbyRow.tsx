...
const NearbyRow: React.FC<NearbyRowProps> = React.memo(({ id, name, rating, distance, inferredCategory, topCardName, topCardReason, onSelect }: NearbyRowProps) => {
...
// Module marker to avoid TS treating this as an ambient/namespace file
export {};
