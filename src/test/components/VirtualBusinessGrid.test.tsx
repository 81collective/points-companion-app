...
console.log('DEBUG: VirtualBusinessGrid.test.tsx top-level import');
import { customRender, screen, waitFor, fireEvent, createMockBusiness, setupTests } from '../testUtils';
// Normalize import (some test transformer chains yield `module.default`)
const { getDefaultExport } = require('../testUtils');
const VirtualBusinessGridModule = require('../../components/common/VirtualBusinessGrid');
const VirtualBusinessGrid = getDefaultExport(VirtualBusinessGridModule);
