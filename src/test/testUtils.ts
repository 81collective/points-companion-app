...
// Ensure both named and default exports are available for different module transform configurations
...
// Helper to normalize module default import variations across transform layers
export const getDefaultExport = (mod: any) => (mod && (mod.default ?? mod));


// Note: Avoid directly mutating `module.exports` to satisfy Next.js build lint rules.
